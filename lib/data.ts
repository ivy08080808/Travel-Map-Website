...
export const travelogues: Travelogue[] = [
  ...
  { id: "zurich-2024-06", title: "Zurich, Switzerland", description: "Lake Zurich and old town strolls.", coverImage: "/images/zurich.jpg", date: "2024-06", route: "/Travelogues/zurich-2024-06" },
  ...
  // 2023 January - Japan
  { id: "tokyo-2023", title: "Tokyo, Japan", description: "Exploring Tokyo's blend of old and new.", coverImage: "/images/tokyo.jpg", date: "2023-01", route: "/Travelogues/tokyo-2023-01" },
  { id: "osaka-2023", title: "Osaka, Japan", description: "Street food and neon nights in Osaka.", coverImage: "/images/osaka.jpg", date: "2023-01", route: "/Travelogues/osaka-2023-01" },
  { id: "kyoto-2023", title: "Kyoto, Japan", description: "Temples and tea houses in Kyoto.", coverImage: "/images/kyoto.jpg", date: "2023-01", route: "/Travelogues/kyoto-2023-01" },
  ...
  { id: "fukui-2023", title: "Fukui, Japan", description: "Coastal scenes and history in Fukui.", coverImage: "/images/fukui.jpg", date: "2023-01", route: "/Travelogues/fukui-2023-01" },
...
export const trips: Trip[] = [
  ...
  },
  {
    ...
    locations: [
      ...
      { id: 12, name: "Provence, France", lat: 43.9500, lng: 5.0500, date: "June 2024", transportMode: "car", link: "/Travelogues/provence-2024-06" },
      { id: 13, name: "Lyon, France", lat: 45.7640, lng: 4.8357, date: "June 2024", transportMode: "bus", link: "/Travelogues/lyon-2024-06" },
      { id: 14, name: "Geneva, Switzerland", lat: 46.2044, lng: 6.1432, date: "June 2024", transportMode: "train", link: "/Travelogues/geneva-2024-06" },
      { id: 15, name: "Zermatt, Switzerland", lat: 46.0207, lng: 7.7491, date: "June 2024", transportMode: "bus", link: "/Travelogues/zermatt-2024-06" },
      { id: 16, name: "Grindelwald, Switzerland", lat: 46.6242, lng: 8.0340, date: "June 2024", transportMode: "bus", link: "/Travelogues/grindelwald-2024-06" },
      { id: 17, name: "Zurich, Switzerland", lat: 47.3769, lng: 8.5417, date: "June 2024", transportMode: "bus", link: "/Travelogues/zurich-2024-06" },
      { id: 18, name: "Prague, Czech Republic", lat: 50.0755, lng: 14.4378, date: "June 2024", transportMode: "bus", link: "/Travelogues/prague-2024-06" },
  ...
  },
  {
    ...
    locations: [
      ...
      { id: 2, name: "Osaka, Japan", lat: 34.6937, lng: 135.5023, date: "January 2023", transportMode: "airplane", link: "/Travelogues/osaka-2023-01" },
      { id: 3, name: "Kyoto, Japan", lat: 35.0116, lng: 135.7681, date: "January 2023", transportMode: "car", link: "/Travelogues/kyoto-2023-01" },
      { id: 4, name: "Takayama, Japan", lat: 36.1461, lng: 137.2522, date: "January 2023", transportMode: "car", link: "/Travelogues/takayama-2023-01" },
      { id: 5, name: "Shirakawa-go, Japan", lat: 36.2556, lng: 136.9064, date: "January 2023", transportMode: "car", link: "/Travelogues/shirakawa-go-2023-01" },
      { id: 6, name: "Kanazawa, Japan", lat: 36.5613, lng: 136.6562, date: "January 2023", transportMode: "car", link: "/Travelogues/kanazawa-2023-01" },
      { id: 7, name: "Fukui, Japan", lat: 36.0652, lng: 136.2216, date: "January 2023", transportMode: "car", link: "/Travelogues/fukui-2023-01" },
  ...
  },
  {
    ...
    locations: [
      ...
      { id: 5, name: "Poznań, Poland", lat: 52.4064, lng: 16.9252, transportMode: "bus", link: "/Travelogues/poznan-2022-07" },
      { id: 6, name: "Berlin, Germany", lat: 52.5200, lng: 13.4050, transportMode: "bus", link: "/Travelogues/berlin-2022-07" },
      { id: 7, name: "Singapore", lat: 1.3521, lng: 103.8198, transportMode: "airplane", link: "/Travelogues/singapore-2022-07" },
